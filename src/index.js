...
document.addEventListener('DOMContentLoaded', async() => {
    ...
    document.getElementById("swarm-connect-btn").onclick = async () => {
        ...
        friend_address = '/p2p-circuit/ipfs/QmcdH9BVjah7pGQqm3x9A8gEfa2qoygBWGupJsKPE3y5af';
        ...
        friend_address = '/p2p-circuit/ipfs/QmQN2N8yKLYZa3nnFRZGRw6jHN73ZabiJGQBub27S9PJRh';
